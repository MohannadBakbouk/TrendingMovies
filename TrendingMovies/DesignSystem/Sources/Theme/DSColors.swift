...
public struct DSColors {
    ...
    public static let secondary = Color(white: 0.12)
    ...
    public static let searchBarFocusedIcon = Color.yellow.opacity(0.95)
    public static let searchBarBorder = Color.white.opacity(0.06)
